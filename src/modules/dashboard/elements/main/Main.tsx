      ...
      <div className="w-full flex">
        ...
        <div className="w-[35%] p-5">
          ...
          <div>
            ...
            <div className="w-full bg-white border rounded p-5 my-3">
              ...
              <div>
                ...
                <div className="w-full px-2 my-1 h-[38px] bg-transparent border rounded-lg 
                    relative flex items-center cursor-pointer" onClick={handleCopyClick}>
                  <small
                    className={`w-[70%] text-sm overflow-hidden overflow-ellipsis whitespace-nowrap 
                      copy-text ${copied ? "bg-blue-200" : "bg-transparent"}`}
                  >
                    {process.env.NEXT_PUBLIC_WEBSITE_URL}/subscribe?username={user?.username}
                  </small>

                  <div className="absolute h-[38px] w-[90px] rounded-r-lg bg-[#DFE7FF] 
          ...
          <div className="w-full bg-white border rounded p-5 my-3">
            ...
            <Button className="bg-[#FBCFE8] text-[#831743] rounded-lg 
          ...
          <div className="w-full bg-white border rounded p-5 my-3">
            ...
            <Link href={"/"}>
              <div className="w-max px-3 my-2 h-[33px] bg-transparent border 
