...
const FeatureHighlight = () => {
  return (
    <div className="w-full md:flex items-center bg-[#9399F4] py-5 text-center 
      md:py-0 md:text-left md:min-h-[55vh]">
      ...
      <div className="md:w-[50%]">
        <h2 className="font-clashDisplay uppercase text-cyber-ink text-3xl md:text-5xl 
          mx-auto mb-2 md:text-left">
          CREATE
        </h2>
        <br />
        ...
        <Button className="bg-white border-[2px] border-[#000] rounded text-2xl 
          !p-7 !px-16 hover:bg-black hover:text-white">
          Start Building
        </Button>
      </div>
    </div>
