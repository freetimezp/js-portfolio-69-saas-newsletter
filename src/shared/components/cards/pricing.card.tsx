...
const PricingCard = ({ active }: { active: string }) => {
  return (
    <div className="w-full md:flex items-start justify-around py-8">
      {/* free plan */}
      <div className="md:w-[400px] min-h-[730px] bg-white rounded p-5 my-5 md:my-0">
        <svg
        ...
        <Button color="primary" className="w-full text-xl !py-6 mt-[58px]">
          Get Started
        </Button>
      ...
      <div className="md:w-[400px] min-h-[730px] bg-white rounded p-5 my-5 md:my-0">
        ...
        <Button
          color="primary"
          className="w-full text-xl !py-6 mt-[58px]"
        >
          Get Started
        </Button>
        <p className="pt-1 opacity-[.7] text-center">
