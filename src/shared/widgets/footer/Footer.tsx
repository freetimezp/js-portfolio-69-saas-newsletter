  ...
  return (
    <footer className="w-full bg-black text-white pt-10">
      <div className="w-[95%] md:flex m-auto py-5">
        <div className="w-full md:w-[40%]">
          ...
          <div className="flex items-center w-full">
            <input
              ...
              className="bg-transparent w-full md:w-[50%] border h-[42px] px-2 rounded 
                rounded-r-[0] outline-none"
            />
            <button className="w-[90px] cursor-pointer rounded-r h-[43px] bg-blue-500 
        ...
        <div className="w-full md:w-[60%] flex md:justify-end justify-center 
          py-5 md:py-0">
          <div className="md:w-[50%] flex justify-around gap-[4rem] lg:gap-0">
            <div>
              <ul>
      ...
      <p className="text-lg text-center pb-10">
        © 2024. FreeTime Studio. All rights reserved.
      </p>
    </footer>
  );
};
